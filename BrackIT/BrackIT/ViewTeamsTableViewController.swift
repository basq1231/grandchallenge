...
class ViewTeamsTableViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    func getFetchedResultsController() ->NSFetchedResultsController {
        fetchedResultsController = NSFetchedResultsController(fetchRequest: teamFetchRequest(), managedObjectContext: managedObjectContext!, sectionNameKeyPath: "playersTeam.name", cacheName: nil)
    ...
    func teamFetchRequest() ->NSFetchRequest {
        ...
        let sortDescriptor = NSSortDescriptor(key: "playersTeam.name", ascending: true)
